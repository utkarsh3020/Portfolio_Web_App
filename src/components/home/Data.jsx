...
const Data = () => {
  ...
  return (
    <div className="home_data">
      <h1 className="home_title" style={{color: darkMode && "white"}}>
        Utkarsh Gupta
        <svg
          width="36"
          height="36"
      ...
      <h2 className="home_subtitle" style={{ color: darkMode && "white"}}>
        I'm a{" "}
      ...
      <a href="#contact" className="button button-flex" style={{backgroundColor: darkMode ? "#222" : "", boxShadow: darkMode ? '0 3px 10px rgb(0 0 0 / 0.5)' : ""}}>
        Say Hello
        <svg
          class="button__icon"
          xmlns="http://www.w3.org/2000/svg"
